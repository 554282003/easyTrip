  ...
  return (
    <div className="pdp-package-detail-page">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${getPackageImage(
            packageData.image
          )})`,
        }}
      >
              ...
              <div className="pdp-package-overview">
                ...
                <div className="pdp-overview-content">
                  ...
                  <p>
                    ...
                    destination with our carefully crafted itinerary. Our
                    package ensures you get the best experience with comfortable
                    accommodations, guided tours, and authentic local
                    experiences.
                  </p>
            ...
            <AnimatedElement animation="fade-right" delay={400}>
              <div className="pdp-package-itinerary">
                ...
                <AnimatedSection
                  staggered={true}
                  staggerDelay={150}
                  className="pdp-itinerary-days"
                >
                  {packageData.itinerary
                    ? packageData.itinerary.map((day, index) => (
                        <div key={index} className="pdp-itinerary-day">
                          <div
                            className={`pdp-day-header ${
                              activeItinerary === index ? "pdp-active" : ""
                            }`}
                            onClick={() => toggleItinerary(index)}
                          >
                            <h3>
                              <span className="pdp-day-number">
                                Day {day.day}
                              </span>
                              {day.title}
                            </h3>
                        ...
                        <div key={index} className="pdp-itinerary-day">
                          ...
                          >
                            <p>
                              ...
                              elit. Nullam in odio vitae justo vestibulum
                              bibendum. Donec eu ornare libero.
                            </p>
                            <ul className="pdp-activities-list">
                              <li className="pdp-activity-item">
                                <i className="fas fa-circle-dot"></i> Morning:
                                Breakfast at hotel
                              </li>
                              <li className="pdp-activity-item">
                                <i className="fas fa-circle-dot"></i> Afternoon:
                                Guided tour
                              </li>
                              <li className="pdp-activity-item">
                                <i className="fas fa-circle-dot"></i> Evening:
