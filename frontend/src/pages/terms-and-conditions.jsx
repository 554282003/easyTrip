        ...
        <div className="policy-content">
          <section className="policy-section">
            ...
            <p>
              ...
              the use of AnyTrip's website. By accessing this website, we assume
              you accept these terms and conditions in full. Do not continue to
              use AnyTrip's website if you do not accept all of the terms and
          ...
          <section className="policy-section">
            ...
            <p>
              When making a booking with AnyTrip, you agree to provide accurate
              and complete information for all travelers. Payment terms are as
              follows:
            </p>
          ...
          <section className="policy-section">
            ...
            <p>
              AnyTrip reserves the right to make changes to any of the
          ...
          <section className="policy-section">
            ...
            <p>
              AnyTrip is not responsible for any issues arising from incomplete
          ...
          <section className="policy-section">
            <h2>6. Liability</h2>
            <p>
              AnyTrip acts as an intermediary between you and the various
          ...
          <section className="policy-section">
            ...
            <div className="policy-contact-info">
              <p>
                <strong>Email:</strong> info@travelpackages.com
              </p>
              <p>
                <strong>Phone:</strong> +91 8511231514
              </p>
              <p>
