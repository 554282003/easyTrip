      ...
      <div className="container policy-container">
        <div className="policy-content">
          <section className="policy-section">
            ...
            <p>
              At AnyTrip, we strive to ensure that our customers are completely
              satisfied with their travel experiences. This Refund Policy
              outlines the terms and conditions for refunds on bookings made
              through our website or directly with our customer service team.
            </p>
          </section>
          ...
          <section className="policy-section">
            ...
            <p>
              ...
              to info@travelpackages.com or through our contact form on the
              website.
            </p>
          </section>
          ...
          <section className="policy-section">
            ...
            <ul className="policy-list">
              ...
              <li>
                Any third-party charges that are non-refundable to AnyTrip
              </li>
            </ul>
          </section>
