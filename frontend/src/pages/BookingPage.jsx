...
function BookingPage() {
  ...
  useEffect(() => {
    ...
    // Fetch package data
    try {
      const foundPackage = packagesData.packages.find(
  ...
  const validateForm = () => {
    ...
    formData.additionalTravelers.forEach((traveler, index) => {
      if (!traveler.fullName.trim())
        errors[`traveler_${index}_fullName`] = "Full name is required";
      ...
      if (firstErrorKey.includes("traveler_")) {
        ...
        setTimeout(() => {
          const element = document.querySelector(
            `.bp-traveler-card:nth-child(${travelerIndex + 2})`
          );
          if (element) {
  ...
  // Handle confirmation
  const handleConfirm = () => {
    // Save booking details to sessionStorage as backup
    sessionStorage.setItem(`bookingDetails_${id}`, JSON.stringify(formData));
  ...
  return (
    <div className="bp-booking-page">
      <div className="bp-booking-header">
          ...
          <AnimatedElement animation="fade-up" delay={200}>
            <div className="bp-booking-form-container">
              <h2 className="bp-form-title">
                <i className="fas fa-user-circle bp-form-icon"></i> Traveler
                Information
              </h2>
              <form className="bp-booking-form" onSubmit={handleSubmit}>
                ...
                <div className="bp-traveler-card bp-primary-traveler">
                  <div
                    className={`bp-traveler-header ${
                      activeCustomer === 0 ? "bp-active" : ""
                    }`}
                  ...
                  <div
                    className={`bp-traveler-content ${
                      activeCustomer === 0 ? "bp-traveler-content-active" : ""
                    }`}
                  >
                    <div className="bp-form-row">
                      <div className="bp-form-group">
                        <label htmlFor="fullName">
                          <i className="fas fa-user bp-field-icon"></i> Full
                          Name <span className="bp-required">*</span>
                        </label>
                        <input
                          type="text"
                          id="fullName"
                      ...
                      <div className="bp-form-group">
                        <label htmlFor="email">
                          <i className="fas fa-envelope bp-field-icon"></i>{" "}
                    ...
                    <div className="bp-form-row">
                      <div className="bp-form-group">
                        <label htmlFor="phone">
                          <i className="fas fa-phone bp-field-icon"></i> Phone
                          Number <span className="bp-required">*</span>
                        </label>
                        <input
                          type="tel"
                          id="phone"
                      ...
                      <div className="bp-form-group">
                        <label htmlFor="gender">
                          <i className="fas fa-venus-mars bp-field-icon"></i>{" "}
                          Gender <span className="bp-required">*</span>
                        </label>
                        <select
                          id="gender"
                          name="gender"
                    ...
                    <div className="bp-form-row">
                      <div className="bp-form-group">
                        <label htmlFor="age">
                          <i className="fas fa-birthday-cake bp-field-icon"></i>{" "}
                          Age <span className="bp-required">*</span>
                        </label>
                        <input
                          type="number"
                          id="age"
                      ...
                      <div className="bp-form-group">
                        <label htmlFor="travelDate">
                          <i className="fas fa-calendar-alt bp-field-icon"></i>{" "}
                          Travel Date <span className="bp-required">*</span>
                        </label>
                        <input
                          type="date"
                          id="travelDate"
                ...
                {formData.additionalTravelers.map((traveler, index) => (
                  <div
                    key={index}
                    className="bp-traveler-card bp-additional-traveler"
                  >
                    <div
                      className={`bp-traveler-header ${
                        activeCustomer === index + 1 ? "bp-active" : ""
                      }`}
                      onClick={() => toggleCustomerDetails(index + 1)}
                    >
                      <h3>
                        <i className="fas fa-user-friends"></i> Traveler{" "}
                        {index + 2}
                        <span className="bp-traveler-subtitle">
                  ...
                  <div className="bp-terms-container">
                    <div className="bp-checkbox-container">
                      ...
                      <label htmlFor="termsAccepted" className="bp-terms-label">
                        I accept the{" "}
                        <a
                          href="https://tripeasy.in/terms-and-conditions"
                          target="_blank"
                    ...
                    {formErrors.termsAccepted && (
                      <div className="bp-error-message bp-terms-error">
                        {formErrors.termsAccepted}
                      </div>
                    )}
                  </div>
                ...
                <div className="bp-form-actions">
                  ...
                  <button type="submit" className="bp-continue-button">
              ...
              <div className="bp-confirmation-info-grid">
                <div className="bp-confirmation-item">
                  ...
                  <div>
                    ...
                    <span className="bp-confirmation-value">
                      {packageData.name}
                    </span>
                  </div>
                </div>
