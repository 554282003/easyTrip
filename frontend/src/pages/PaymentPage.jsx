...
import logo from "../assets/logos/cashfree-logo.png"
...
function PaymentPage() {
  ...
  }, [bookingDetails, packageDetails, id, navigate])
  ...
  const verifyPaymentFromRedirect = async (orderId) => {
    ...
    try {
      ...
      if (data.status === "PAID") {
        ...
        // Make sure to store this data before redirecting
        if (bookingDetails && packageDetails) {
          console.log("Storing booking details in sessionStorage before redirect")
        ...
        // Redirect to payment status page after a short delay to ensure data is stored
        setTimeout(() => {
          navigate(
              ...
              <div className="pp-payment-form-container">
                ...
                <div className="pp-cashfree-info">
                  <div className="pp-cashfree-logo">
                    <img src={logo || ""} alt="Cashfree" className="pp-cashfree-logo-img" />
