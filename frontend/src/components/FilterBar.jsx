...
function FilterBar({ onFilterChange, initialFilters = {} }) {
  ...
  const allDestinations = [
    ...new Set([
      ...packagesData.destinations.map((dest) => dest.name),
      ...packagesData.packages.map((pkg) => pkg.location),
    ]),
  ].sort();
      ...
      const filtered = allDestinations
        ...
        .filter((dest, index, self) => {
          ...
          const longerVersionExists = self.some(
            (d) =>
              d !== dest && d.startsWith(baseLocation) && d.includes(", India")
          );
      ...
      <div className="search-bar-content">
        <div className="search-bar-header">
          ...
          <p className="search-subtitle">
            Search and compare from thousands of destinations
          </p>
        </div>
          ...
          <div className="search-fields-container">
            <div className="search-group">
              ...
              <div className="input-wrapper">
                <input
                  ...
                  onFocus={() => {
                    if (filters.destination.trim().length > 0) {
                      setShowSuggestions(true);
                    }
                  }}
                ...
                >
                  ...
                  <i
                    className={`fas fa-chevron-down ${
                      activeDropdown === "duration" ? "rotate" : ""
                    }`}
                  ></i>
                </div>
                {activeDropdown === "duration" && (
            ...
            <div className="search-group">
              ...
              <div
                ...
                tabIndex={0}
                onKeyDown={(e) =>
                  handleDropdownKeyDown(e, budgetOptions, handleBudgetSelect)
                }
              >
                <div
                  className="dropdown-selected"
            ...
            <div className="search-group">
              ...
              <div
                ...
                tabIndex={0}
                onKeyDown={(e) =>
                  handleDropdownKeyDown(e, sortByOptions, handleSortBySelect)
                }
              >
                <div
                  className="dropdown-selected"
